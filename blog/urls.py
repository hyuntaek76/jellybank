...
urlpatterns = [
    ...
    path('.well-known/pki-validation/1FB3E66D1EC1F60AB90807266BA7E218.txt', TemplateView.as_view(template_name="0951996431BB19E15491559D4B5A3F68.txt", content_type="text/plain"), name="project_ssl_file"),
